describe('manageEmployee', function () {
    ...
    it('emailไม่ถูกต้อง', function () {
        ...
        cy.get('#modalInsert > .modal-dialog > .modal-content > .modal-body > form.ng-dirty > :nth-child(1) > .col > :nth-child(5) > .col-sm-9 > .form-control').type('12345678')
